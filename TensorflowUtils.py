...
def conv2d_basic(x, W, bias):
    print("enter--TensorflowUtils--conv2d_basic->")
    conv = tf.nn.conv2d(x, W, strides=[1, 1, 1, 1], padding="SAME")
    return tf.nn.bias_add(conv, bias)


def conv2d_strided(x, W, b):
    print("enter--TensorflowUtils--conv2d_strided->")
    conv = tf.nn.conv2d(x, W, strides=[1, 2, 2, 1], padding="SAME")
    return tf.nn.bias_add(conv, b)


def conv2d_transpose_strided(x, W, b, output_shape=None, stride = 2):
    print("enter--TensorflowUtils--conv2d_transpose_strided->")
    # print x.get_shape()
    # print W.get_shape()
...
def leaky_relu(x, alpha=0.0, name=""):
    print("enter--TensorflowUtils--leaky_relu->")
    return tf.maximum(alpha * x, x, name)


def max_pool_2x2(x):
    print("enter--TensorflowUtils--max_pool_2x2->")
    return tf.nn.max_pool(x, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")


def avg_pool_2x2(x):
    print("enter--TensorflowUtils--avg_pool_2x2->")
    return tf.nn.avg_pool(x, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")


def local_response_norm(x):
    print("enter--TensorflowUtils--local_response_norm->")
...
def process_image(image, mean_pixel):
    print("TensorflowUtils====process_image====image - mean_pixel")
    print(image - mean_pixel)
